...
class config:
    ...
    small_epsilon = 0 # the epsilon for small perturbation pixels
    sig_beta = 0 # the beta for significant perturbation pixels
    ...
    search_region = False # flag specifying where to search the significant perturbed region or not
